...
summary: Review and investigate potential attack alerts and security warnings with detailed evidence, user information, and action history to rapidly respond to threats.
---
...
[.lead]
The Workload Security Alerts page provides comprehensive investigation tools for tracking detected threats and suspicious activities. Review attack timelines, filter by severity and status, track user behavior, view evidence details, and monitor automated response actions to rapidly identify and investigate security incidents. 
