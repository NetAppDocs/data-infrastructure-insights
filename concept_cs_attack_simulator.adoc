...
= Workload Security: Simulating Abnormal File Tampering
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
You can use the instructions on this page to simulate file tampering for testing or demonstrating Workload Security using the included Ransomware Simulation script.
