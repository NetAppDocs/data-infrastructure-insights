...
A new toggle in the VM Analyzer view allows you to hide mounted volumes without a datastore, offering a cleaner view to simplify troubleshooting VMs.

image:vm_analyzer_datastore_only_view.png[VM Analyzer showing the toggle that hides mounted volumes without a datastore]
...
image:user_data_edit_slideout.png[Asset details slideout showing User Data in read-only mode with the pencil icon used to enter edit mode, width=400]

image:user_data_edit_lp.png[Asset landing page with User Data opened in edit mode and ready to save changes, width=200]
