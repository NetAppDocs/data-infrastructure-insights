...
//Activate now! Ask your Tenant Owner to activate the AI Assistant by clicking on the "owl" and accepting the Terms and Conditions.

The DII AI Assistant is available now as a Limited Preview. link:/concept_preview_features.html[Learn more] about Data Infrastructure Insights Preview features.
