...
The DII AI Assistant is now more convenient than ever, with its own "Home" page where you can converse freely. Start a new conversation quickly or pick up the last conversation where you left off.

image: AI_dashboard_page_menu.png[AI Assistant Nav Menu]
