...
=== DII's AI Assistant is Available to All!

The Data Infrastructure Insights AI Assistant is moving from preview to full availability, and along with this evolution comes the following enhancements:

* Azure region availability: For customers whose DII site is hosted on Azure, the DII Assistant is now ready to help you. 
* Up to 7 days of data: The Assistant can access up to 7 days worth of high resolution metrics for your data analysis and insights.
