...
DII adds the abiliy to modify system monitors (sometimes called canned or default monitors). Change a monitor's name, filters, or grouping without first having to create a duplicate of the monitor.
