...
Note: The AI Assistant is currently available as a limited preview. Contact your NetApp Sales Representative for more information.  
The AI Assistant is available for DII tenants deployed on AWS.
