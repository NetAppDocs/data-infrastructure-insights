...
image:query_sharing_dialog.png[setting permissions on a query, width=300]
...
Improved dashboard design helps you see what matters most. Enhanced visual clarity with drop shadow borders that separate widgets, removed separator lines to reduce clutter, and gridline removal in charts so you can focus on your data insights. These refinements create a cleaner, more intuitive dashboard experience that makes spotting trends and anomalies faster and easier.

image:[drop shadows on widgets]
