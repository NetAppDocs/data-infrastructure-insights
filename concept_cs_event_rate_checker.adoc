...
summary: Use the SVM Event Rate Checker to measure NFS/SMB event rates and determine optimal Agent sizing before deploying Workload Security data collectors.
