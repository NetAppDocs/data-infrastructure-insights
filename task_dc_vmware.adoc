...
[.lead]
Configure the VMware vSphere data collector to gather comprehensive inventory and performance data from your virtualization environment, including VMs, ESXi hosts, datastores, and related infrastructure components.
