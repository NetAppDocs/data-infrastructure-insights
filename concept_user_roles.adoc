...
|Same as Administrator
|Same as Administrator
|Same as Administrator, as well as manage SSO Authentication and Identity Federation configuration. Can also assign additional owners. Can also assign additional owners and add clients on the Managed Service Provider (MSP) master tenant."
