...
link:reporting_schema_capacity.adoc[Schema Tables - Capacity]
link:reporting_schema_capacity_efficiency.adoc[Schema Tables - Capacity Efficiency]
link:reporting_schema_fs_util.adoc[Schema Tables - File System Utilization]
link:reporting_schema_inventory.adoc[Schema Tables - Inventory]
link:reporting_schema_performance.adoc[Schema Tables - Performance]
link:reporting_schema_ports.adoc[Schema Tables - Ports]
