...
link:schema/reporting_schema_capacity.adoc[Schema Tables - Capacity^]
link:schema/reporting_schema_capacity_efficiency.adoc[Schema Tables - Capacity Efficiency^]
link:schema/reporting_schema_fs_util.adoc[Schema Tables - File System Utilization^]
link:schema/reporting_schema_inventory.adoc[Schema Tables - Inventory^]
link:schema/reporting_schema_performance.adoc[Schema Tables - Performance^]
link:schema/reporting_schema_ports.adoc[Schema Tables - Ports^]
