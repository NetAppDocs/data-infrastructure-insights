...
summary: Ensure your Workload Security Agent deployment environment meets minimum operating system, CPU, memory, and disk space requirements for optimal performance and data collection.
